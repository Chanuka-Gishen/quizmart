...
const LoginController = () => {
  ...
  const handleSignIn = async () => {
    if (formik.isValid && formik.dirty) {
      ...
      await backendAuthApi({
        ...
        if (responseUtil.responseIsSuccess(res.data.responseCode)) {
  ...
  return (
    <Login formik={formik} showPassword={showPassword} handleShowPassword={handleShowPassword} isLoading={isLoading} />
  );
};
